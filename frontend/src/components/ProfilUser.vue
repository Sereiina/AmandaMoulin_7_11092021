...
<template>
  <div class="wrap-profil">
    ...
    <button class="profil-button-modify" @click="nameEditForm = !nameEditForm">
      Changer mon nom
    </button>
    <Modal v-show="nameEditForm" @close="nameEditForm = false">
      <template v-slot:header> Changez vos informations </template>
      ...
      <template v-slot:body>
        <form class="profil-modify" @submit="editName(inputNom, inputPrenom)">
          ...
          <input
            class="profil-submit"
            type="submit"
            value="Changer ses informations"
          />
        </form>
      </template>
    ...
    <button
      class="profil-button-modify"
      @click="emailEditForm = !emailEditForm"
    >
      Changer mon email
    </button>
    <Modal v-show="emailEditForm" @close="emailEditForm = false">
      <template v-slot:header> Changer mon email </template>
    ...
    <button
      class="profil-button-modify"
      @click="passwordEditForm = !passwordEditForm"
    >
      Changer mon mot de passe
    </button>
    <Modal v-show="passwordEditForm" @close="passwordEditForm = false">
      <template v-slot:header> Changer mon mot de passe </template>

      <template v-slot:body>
        <form
          class="profil-modify"
          @submit.prevent="
            editPassword(oldPassword, newPassword, confirmationPassword)
          "
        >
